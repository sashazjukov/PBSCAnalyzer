...
namespace PBSCAnalyzer
{
    ...
    public class UserSnippetConfiguration : AppConfiguration
    {
        public UserSnippetConfiguration()
        {
            UserSnippets = new List<UserTextSnippet>();           
        }

        public List<UserTextSnippet> UserSnippets { get; set; }        
    }
